			...
			<div class="row">
				<div class="col-sm-3 border-right">
					...
					>
						...
						<span class="ml-2">SB</span>
					</div>

					<div
						v-if="
							order.use2020Pricing || order.lgOrder || orderLine.useLGPricing
						"
					>
						<div class="form-group mb-1">
					...
					<div class="form-group mb-1" v-else>
						<label for="priceBreak" class="small my-0">Price Break:</label>
						<select
							class="form-control form-control-sm"
							id="jobType"
				...
				<div class="col-sm-6">
					<div class="row">
						...
						<div
							...
							v-if="
								(orderLine.graphicCode && colourWays.length) ||
				...
				<div class="col-sm-3 border-left">
					<div class="form-group mb-1 col-sm-12">
						<label for="tracingCharge" class="small my-0"
							>Tracing: ($ Value)</label
						>
						<input
							type="number"
					...
					<div class="form-group mb-1 col-sm-12">
						<label for="creativeCharge" class="small my-0"
							>Creative: ($ Value)</label
						>
						<input
							type="number"
							class="form-control form-control-sm"
					...
					<div class="form-group mb-1 col-sm-12">
						<label for="scaledArtCharge" class="small my-0"
							>Scaled Art: ($ Value)</label
						>
						<input
							type="number"
							class="form-control form-control-sm"
					...
					<div class="form-group mb-1 col-sm-12">
						<label for="colourWashCharge" class="small my-0"
							>Colour Wash: ($ Value)</label
						>
						<input
							type="number"
							class="form-control form-control-sm"
