	...
	<div class="card border-dark">
		...
		<div class="row card-body p-2">
			<div class="col-sm-3">
				...
				<div class="form-group">
					<label for="customerNotes" class="small my-0"
			...
			<div class="col-sm-7 border-left border-right mb-0">
				<div class="row">
					...
					<div class="form-group mb-1 col-sm-12">
						<label for="shipToAddress" class="small my-0"
					...
					<div
						...
						v-if="
							order.shipToCountry === 'CA' ||
								order.shipToCountry === 'CANADA' ||
								order.shipToCountry === 'CAN'
						"
					>
					...
					<div class="form-group col-sm-12">
						<label for="signedOffDate" class="small my-0"
							>Signed-Off Date</label
						>
						<DatePicker
			...
			<div class="col-sm-2">
				...
				<div class="form-group mb-1">
					<label for="priorityShipping" class="small my-0"
						>Priority Shipping ($ Value)</label
					>
					<input
						type="number"
						class="form-control form-control-sm"
				...
				<div class="form-group mb-1">
					<label for="revisionCharge" class="small my-0"
						>Extra Revisions ($ Value)</label
					>
					<input
						type="number"
						class="form-control form-control-sm"
