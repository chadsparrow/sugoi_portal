...
module.exports = {
	...
	// @route   GET /proofs/:id
	// @access  Private
	getProofPage: async (req, res, next) => {
		try {
	...
	// @access  Private - Edit Proofs role
	getQCEditPage: async (req, res, next) => {
		try {
			const foundProof = await Proof.findById(req.params.id);
	...
	// @access  Private - Edit Proofs role
	archiveQCNote: async (req, res, next) => {
		try {
			const id = req.params.id;
	...
	// @access  Private - Edit Proofs role
	viewQCArchives: async (req, res, next) => {
		try {
