...
// @access  Private
exports.showOrderPO = async (req, res, next) => {
	try {
...
// @access  Private
exports.showOrderXML = async (req, res, next) => {
	try {
...
// @route   GET /orders
// @access  Private
exports.getInProgressOrders = async (req, res, next) => {
	try {
...
// @access  Private
exports.getInitialOrders = async (req, res, next) => {
	try {
...
// @access  Private
exports.getAddOrderPage = async (req, res, next) => {
...
// @access  Public
exports.viewOrderPage = async (req, res, next) => {
	try {
...
// @access  Private - Edit Orders Role
exports.getEditOrderPage = async (req, res, next) => {
	try {
