...
exports.getProdOrders = async (req, res, next) => {
	try {
...
// @route   GET /prod/open
// @access  Private - View Prod Role
exports.getProdOpenOrders = async (req, res, next) => {
	try {
...
// @access  Private - View Prod Role
exports.getProdPendingOrders = async (req, res, next) => {
	try {
...
// @access  Private - View Prod Role
exports.getProdCancelledOrders = async (req, res, next) => {
	try {
...
exports.getProdEditPage = async (req, res, next) => {
	try {
...
// @access  Private - Edit Prod Role
exports.updateProdOrder = async (req, res, next) => {
	try {
		const {
			latestShipDate,
			vendorConfirmShip,
